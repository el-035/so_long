...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/23 15:38:46 by efittant          #+#    #+#             */
/*   Updated: 2024/12/23 15:38:49 by efittant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parsing_conditions(t_mlx *data, int x, int y)
{
	...
	if (data->map[y][x] == '1')
		mlx_put_image_to_window(data->mlx, data->window, data->obstacle, \
				(x * 48), (y * 48));
	if (data->map[y][x] == 'E')
	{
		mlx_put_image_to_window(data->mlx, data->window, data->end_closed, \
				(x * 48), (y * 48));
